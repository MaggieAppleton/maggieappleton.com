...
const Hero = () => {
    ...
    return (
        ...
        >
          ...
          `}
                >
                    Creates visual explanations about design, anthropology, and
                    programming.
                </h2>
                <h4
                    css={css`
                    ...
                    `}
                >
                    UX designer, anthropologist, illustrator & mediocre
                    developer at{' '}
                    <a
                ...
                <section>
                    ...
                    <section className="garden">
                        ...
                        <p
                            ...
                            `}
                        >
                            A consistently tended collection of half-baked
                            notes, research, and sketches.
                        </p>
                        ...
                        {illustrationQuery.edges.map(
                            ({ node: illustration }) => (
                                <IllustrationCard
                                    ...
                                    id={illustration.id}
                                    fluid={
                                        illustration.frontmatter.cover
                                            .childImageSharp.fluid
                                    }
                                />
                            ),
                ...
                <section className="books">
                    <span className="bookTitle">
                        ...
                        <p
                            ...
                            `}
                        >
                            A past and present reading collection. Complete with
                            very loose and opinionated notes.
                        </p>
                    ...
                    {bookQuery.edges.map(({ node: book }) => (
                        <Book
                            ...
                            key={book.id}
                            fluidImg={
                                book.frontmatter.cover.childImageSharp.fluid
                            }
