...
<h5 style={{marginBottom: '10px', color: '#9EA0B7', textAlign: 'center', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.5px'}}>Document</h5>
...
<div style={{position: 'relative', width: '400px', height: '250px', border: '2px solid #CECFE1', margin: '1em auto 3em', borderRadius: '6px'}}>
