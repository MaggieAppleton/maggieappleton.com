...
The way binary code enables us to simplify information down into single bytes that can be easily stored, copied, manipulated, and sent through fibre optic cables at warp speed, is the essential basis of all modern communication technology.  It's also a sufficient catch-all for the kinds of things Digital Anthropologists study.
