...
As I'm reading this article on Wired, perhaps small indicators show up next to each paragraph showing the number of times each it's been cited somewhere else on the web. Try hovering over the number 4 here and clicking:
...
This is just a simple Figma mockup to demonstrate the idea. An overlay might appear with links to those other transclusion instances.
