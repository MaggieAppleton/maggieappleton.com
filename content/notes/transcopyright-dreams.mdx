...
If we want to offer a more modular browsing experience, we could also have this link modal expand into the page itself. This allows us to stay within the current article, but also quickly check what discussions and narratives are happening around it – a feature that would _certainly_ help pop a few filter bubbles.
