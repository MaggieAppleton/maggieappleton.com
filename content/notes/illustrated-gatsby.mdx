...
[Khaled Garbaya](https://khaledgarbaya.net/) just put out an egghead course on
...
I've been working on a set of illustrations that capture the _key concepts_ from Khaled's course. They don't summarise all the course content. They're just supporting material that help clarify the most important ideas.

First up is a **big picture view** showing all the essential parts of a Gatsby site.

<Image alt="Gatsby is a collection of tools for building static sites" src="https://res.cloudinary.com/dg3gyk0gu/image/upload/c_scale,f_auto,q_100,w_1200/v1597741851/maggieappleton.com/egghead-course-notes/intro-gatsby/IntroGatsby_1_Small.png" />
...
<Image alt="Diagram of a pageQuery request inside a page, and a static query request inside a component" src="https://res.cloudinary.com/dg3gyk0gu/image/upload/v1597741854/maggieappleton.com/egghead-course-notes/intro-gatsby/IntroGatsby_2_Small.png" />
...
<Image alt="Animation of a page rendering static HTML elements first, then being updates with React afterwards" src="https://res.cloudinary.com/dg3gyk0gu/image/upload/v1597741856/maggieappleton.com/egghead-course-notes/intro-gatsby/IntroGatsby_3_Animation.gif" />
...
React also handles any changes and user interactions by rehydrating the page.