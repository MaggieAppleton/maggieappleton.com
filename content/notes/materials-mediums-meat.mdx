...
Materials are the physical tools you need to draw with. iPads are one option. Staedler felt pens and moleskines are another. Copic markers in Cottonwood Arts sketchbooks. Compressed charcoal on Canson coldpress paper. Progressos on  newsprint. 
