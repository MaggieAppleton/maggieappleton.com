...
<h2>Greensock in Plain English</h2>

<p>Greensock is a JavaScript library that changes DOM nodes directly. Once the the HTML of a website has been transformed into a set of DOM nodes by the browser, Greensock manipulates those nodes to create our animations.</p>
...
<Tween to={{
    ...
    <div id="redbox" style={{ width: '100px', height: '100px', background: '#2D2A55', borderRadius: '4px', margin: '2em' }} />
</Tween>
