...
<Tween to={{
    ...
    <div id="toBox" style={{ width: '100px', height: '100px', background: '#2D2A55', borderRadius: '4px', margin: '2em' }} />
</Tween>
...
<Tween from={{
    ...
    <div id="fromBox" style={{ width: '100px', height: '100px', background: '#2D2A55', borderRadius: '4px', margin: '2em' }} />
</Tween>
