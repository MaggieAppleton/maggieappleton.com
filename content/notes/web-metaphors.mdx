...
<h5>Epistemic Status</h5>
<h6>Reasonably confident. I'm well read in the field of conceptual metaphor, and web metaphors in particular. I'm not an expert in the technical details of internet infrastructure and only have a wikipedia-level understanding of protocols like TCP/IP and HTTP. I developed this idea in conversation with other folks in the Citizens of Hypertext club</h6>