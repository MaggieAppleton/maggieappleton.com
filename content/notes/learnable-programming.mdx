...
As I began exploring these visual programming platforms, I started to notice patterns of my own. While Victor defined a set of idealised principles for a non-existent system, I became more interested in finding emergent patterns in systems that already exist.
