...
What I want to explore here is the relative **lack of graphical and spatial design** in our current programming environments. While we've crafted widely accessible GUIs for everyone else, programmers remain in the land of typed commands. We don't use many shapes and spatial relationships to communicate meaning. We instead rely on words.

We write `let topScores = [89, 97, 102, 123]` instead of creating a graphical layout like:
...
By advocating for graphical and spatial programming interfaces, 
