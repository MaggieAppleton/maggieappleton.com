...
Bret outlined a set of principles he believed all learnable programming environments should follow. He argues any good educational platform should allow learners to...
...
Bret's principles amount to a kind of [[Pattern Language]] - they're a set of design rules that define how a system should work.
