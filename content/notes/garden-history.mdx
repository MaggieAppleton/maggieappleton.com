...
Other gardeners include an **epistemic status** on their posts – a short statement that makes clear how they know what they know, and how much time they've invested in researching it. As in, "Been thinking about this since reading _Seeing Like a State_, knocked it out in a 20-minute burst"
...
Devon Zuegal adds _epistemic status_ and _epistemic effort_ to posts, indicating both their certainty level about the material, and how much effort went into making it. They also argue [Epistemic statuses are lazy](https://devonzuegel.com/post/epistemic-statuses-are-lazy-and-that-is-a-good-thing), which is a feature not a bug.

<ImageFrame width="1000px" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/v1621838735/maggieappleton.com/notes/garden-history/Screenshot_-_2021-05-24_07.44.48_shrink_rg7rec.png" alt="Epistemic effort and epistemic status metadata at the top of Devon Zuegal's writing" showalt />


In a similar vein, Shawn Wang has written the gardening [Terms of Service](https://www.swyx.io/digital-garden-tos). They ask the reader to allow the writer to be wrong, offer constructive criticism, and attribute their work. They ask gardeners to be considerate of others (don't share private information or name and shame), offer epistemic disclosure, and respond to feedback.
