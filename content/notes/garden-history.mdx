...
Gardens are organised around **contextual relationships and associative links**, rather than chronological time. The concepts and themes within each note determine how it's connected to others. 

Traditional blogs use timelines as their primary organisational system. Posts are presented in reverse chronological order by their publication date. Gardens don't consider publication dates the most important feature of a piece of writing. Instead they highlight related content by creating prominent links between notes. 
...
You should include some indicator of how "done" your posts are. This could be with a simple categorisation system such as _fleeting thought_, _

I find it helpful to also include the dates I "planted" and "last tended" a post.
...
Historically, monocropping has been the quickest route to starvation, pests, and famine. Don't be a potato farmer while everyone else is sustainably intercropping the [three sisters](https://en.wikipedia.org/wiki/Three_Sisters_(agriculture)).
