...
Tools like [Obsidian](https://obsidian.md/), [TiddlyWiki](https://tiddlywiki.com/), [Notion](https://www.notion.so/), and [Hyperdraft](https://hyperdraft.rosano.ca/) are all great options. Many of them offer fancy features like nested folders, [[Bi-Directional Links]], footnotes, and visual graphs. 
