...
aliases: ['Digital Gardeners', 'Digital Gardening', 'Digital Gardens', 'Digital Garden', 'History and Ethos of Digital Gardening']
slug: garden-history
...
<FullWidthImage width="850px" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_100,w_850/v1614174712/maggieappleton.com/notes/garden-history/garden-main_ayoaqo.png" />
...
<FullWidthImage width="1000px" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_100,w_1000/v1616170717/maggieappleton.com/notes/garden-history/growth-leaves_gtdalf.png" />
...
Mark Bernstein's 1998 essay <a href="http://www.eastgate.com/garden/Enter.html">Hypertext Gardens</a> appears to be the first recorded mention of the term. Mark was part of the early hypertext crowd – the developers figuring out how to arrange and present this new medium.
...
<img src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_100,w_350/v1614174711/maggieappleton.com/notes/garden-history/stream-2_shrink_wz2iiq.png" /> 

<img src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_100,w_350/v1614174705/maggieappleton.com/notes/garden-history/stream-3_shrink_mk2rgc.png" />

<img src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_100,w_350/v1614174704/maggieappleton.com/notes/garden-history/stream-1_shrink_n4rjm8.png" />

<img src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_100,w_350/v1614174705/maggieappleton.com/notes/garden-history/stream-4_shrink_sddiiw.png" />
...
<ImageFrame width="1050px" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/c_scale,f_auto,q_100,w_1200/v1620979473/maggieappleton.com/notes/garden-history/mit-gardens.png" showalt alt="A feature about digital gardening on MIT's tech review" />
...
https://twitter.com/ryanflorence/status/1260368292851535879
...
This runs counter to the time-based structure of traditional blogs. Posts are presented in reverse chronological order by their publication date. Gardens don't consider publication dates the most important feature of a piece of writing. Instead they highlight related content by creating prominent links between notes. 
...
<FullWidthImage width="950px" alt="A linear timeline of posts vs. a spatial layout of connected posts" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/v1621774501/maggieappleton.com/notes/garden-history/topographytimelines_shrink_jxgw9l.png" />
...
The isn't how we usually think about writing on the web. Over the last decade, we've moved away from casually posting live journal entries. We now pen "articles" and "essays" that are carefully crafted, edited, revised, and published with a timestamp. When it's done, it's done. We act like tiny magazines, sending our writing off to the printer.
...
<FullWidthImage width="950px" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/v1621773885/maggieappleton.com/notes/garden-history/gardentime_rrsecv.png" alt="A graph of time versus amount of work. Gardening involves small amounts of work over time, while classic blogging involves a lot of work all at once." />
...
Putting anything imperfect on the web may feel strange. We have all been trained to behave like tiny, performative corporations when it comes to presenting ourselves online. Blogging evolved in the  [Premium Mediocre](https://www.ribbonfarm.com/2017/08/17/the-premium-mediocre-life-of-maya-millennial/) culture of Millenialism as a way to Promote Your Personal Brand™ and market your SEO-optimized Content.
...
This could be with a simple categorisation system. I personally use _seedlings_ for rough and early ideas, _budding_ for work I've cleaned up and clarified, and _evergreen_ for work that is reasonable completeness (though I still tend these over time). I also include the dates I "planted" and "last tended" a post so people know 

Other gardeners include an **epistemic status** on their posts – a short statement that makes clear how they know what they know, and how much time they've invested in researching it. As in, "Been thinking about this since reading _War and Peace_, knocked it out in a 20-minute burst"

[Gwern.net](https://www.gwern.net/index) was one of the earliest and most consistent gardeners to offer meta-reflections on their work. Each entry comes with a start and end date, a _draft_, _in progress_, or _finished_ tag, a 1-10 certainty tag, and a 1-10 importance tag. 

<ImageFrame width="1000px" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/v1621499882/maggieappleton.com/notes/garden-history/Screenshot_-_2021-05-20_09.35.37_shrink_x79dnz.png" showalt alt="The metadata avaliable on each of Gwern's essays" />

Gwern explains how these work in their extensive [guide](https://www.gwern.net/About#confidence-tags) to the site – well worth reading if you're designing your own epistemological system.

In a similar vein, Shawn Wang has written the gardening [Terms of Service](https://www.swyx.io/digital-garden-tos) which I love. They ask the reader to allow the writer to be wrong, offer constructive criticism, and attribute their work. They ask gardeners to be considerate of others (don't share private information or name and shame), offer epistemic disclosure, and respond to feedback.
...
<FullWidthImage width="1050px" alt="a spectrum of digital gardening, ranging from chaos streams to cultivated performance" src="https://res.cloudinary.com/dg3gyk0gu/image/upload/c_scale,w_1600/v1593765637/maggieappleton.com/notes/garden-history/digital-garden.png" />

<Halfspacer />

### 4. Playful, Personal, and Experimental

Gardens are by nature non-homogenous. No two gardens should be alike. Even if you plant the same plants as your neighbours, you plant them in a different arrangement.
...
<FullWidthImage width="800px" alt="A row of four plants where three look identical and one is wild and different" src="https://res.cloudinary.com/dg3gyk0gu/image/upload/v1609617065/maggieappleton.com/notes/garden-history/unique-gardens_shrink.png" />
...
<BasicImage width="800px" src="https://res.cloudinary.com/dxj9qr5gj/image/upload/v1621781288/maggieappleton.com/notes/garden-history/intercropping-garden_shrink_mx6nx8.png" />

Historically, monocropping has been the quickest route to starvation, pests, and famine. Don't be a potato farmer while everyone else is sustainably intercropping.
...
No one can take your garden away. If you give it a bit of forethought – storing notes in flat markdown files – you can build it in a way that easily transfers as platforms and technologies inevitably change.
