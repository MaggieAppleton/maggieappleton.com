...
Over the last decade, our writing on the web has moved away from casually posting blogs and live journal entries. We now publish "articles" and "essays" that are carefully crafted, edited, revised, and published with a timestamp. When it's done, it's done. We act like tiny magazines, sending our writing off to the printer.
