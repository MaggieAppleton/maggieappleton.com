...
[Stian Håklev](http://reganmian.net/blog/), a fellow [[Roam Gardener]] and twitter friend, clued me in to the field of **Computer-Supported Collaborative Learning**.<Footnote count={1}>Stian is a fascinating thinker, and I'd recommend <a href="https://louis-and-kyle.simplecast.com/episodes/stian-haklev-012">this podcast interview</a> to hear about his PhD in CSCL and applying it at <a href="https://www.minervaproject.com/">The Minerva Project</a></Footnote>
...
<h2 style={{marginBottom: '1em'}}>Essential Questions and Key Concepts</h2>
...
All the papers makes clear that collaboration in and of itself doesn't magically produce understanding. Instead, it needs to be designed, structured, and well-facilitated to lead to learning.

Most of the research is focused on designing these intentional collaborative experiences. As well as the systems that make them possible (aka. apps, tools, platforms, all that jazz).
...
These are not new pedagogical findings, but CSCL is exploring how digital mediums are particularly well-suited to enabling them. Not just within small groups, but at scale. Perhaps across the entire of Twitter.
...
<ResearchItem title="Computer Supported Collaborative Learning and Intelligent Tutoring Systems" link="https://www.cs.cmu.edu/~bmclaren/pubs/TchounikineEtAl-CSCLandITS-ITSBook2010.pdf" author="Tchounikine, Rummel, and McLaren (2010)">

"The occurrence of **knowledge-generative interactions** is not a
given: such <mark>interactions do not necessarily emerge spontaneously"</mark> (Cohen 1994; Salomon and Globerson 1989)
...
It quickly became clear **macro-scripts** are the bread and butter of CSCL systems. These are the [[Pattern Languages]] of the field. 

CSCL Macro-scripts describe how the learning experience will play out. It includes tasks, subtasks, roles for learners, the constraints and rules for interaction, and the digital tools to use. Essentially, it sets up the whole dinner party for you, so participants can just show up and know all the logistics are taken care of.
...
<ResearchItem title="Scripting Computer-Supported Collaborative Learning: Cognitive, Computational and Educational Perspectives" link="https://www.researchgate.net/publication/321610653_Scripting_Computer-Supported_Collaborative_Learning_Cognitive_Computational_and_Educational_Perspectives" author="Fischer, F. et al. (2007)">
...
<ResearchItem title="Over-scripting CSCL: The risks of blending collaborative learning with instructional design" link="https://pdfs.semanticscholar.org/1556/e5d2f93f6400457b422a011d7d93a3aa29fe.pdf" author="Dillenbourg (2002)">
...
One of my favourite elements of macro-scripts are that they define clear **roles** for each participant.

Most of us have been in events with  _facilitators_ and _scribes_ but we rarely expand on these.

The [Group Work Roles](http://edutechwiki.unige.ch/en/Group_work_roles) page on EduTech Wiki (an overall great place) has an enourmous collection of role "recipes" depending on the size of the group, context, and goals.
...
Coined by [Etienne Wegner](https://wenger-trayner.com/), a community of practice is a group of people "who **share a concern, a set of problems, or a passion about a topic**, and who deepen their knowledge and expertise by interacting on an ongoing basis."<Footnote count={3}><a href="https://wenger-trayner.com/introduction-to-communities-of-practice/">Introduction to communities of practice</a> - Etienne and Beverly Wenger-Trayner (2015)</Footnote>
...
<!-- #### What can we learn from CSCL to help cultivate learning communities online?



<h2 style={{marginBottom: '1em'}}>References and Further Reading</h2>

<ResearchItem title="Computer Support For Collaborative Learning: Foundations for a CSCL Community" link="http://www.gerrystahl.net/hci/cscl2002intro.pdf" author="Stahl, G. (2002)" /> -->
