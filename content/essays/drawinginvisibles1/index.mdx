...
This is a long, overdue case study showing how I make an <a to="https://egghead.io/">egghead</a> course illustration.

It spans everything from <a to="https://en.wikipedia.org/wiki/Conceptual_metaphor">cognitive metaphor theory</a> to Photoshop rendering so I hope you have a hot, caffeinated beverage with you.
...
I'm <a to="http://maggieappleton.com/">Maggie</a> and I make all the things on this site. For the last half decade I've also been the art director & lead illustrator over at <a to="https://egghead.io">egghead</a>.
...
The guinea pig for this case study is going to be <a to="https://twitter.com/mikesherov">Mike Sherov</a>'s course on <a to="https://egghead.io/courses/web-security-essentials?af=54fd64">Web Security Essentials</a>.
...
I do all my brainstorming and sketching in <a to="https://procreate.art/">Procreate</a> on an iPad Pro 12.5"
Once I'm ready to make the final, I use a combination of Adobe Illustrator and Photoshop. My main machine is a Macbook Pro 2015. It's hooked up to a <a to="https://www.wacom.com/en-us/products/pen-displays/cintiq-22-hd">Wacom Cintiq 22HD</a> monitor that allows me to hand-paint in details.
...
I can tell you <a to="https://www.wired.com/video/watch/5-levels-4">a quantum computing bit is like a spinning coin that is neither nor heads or tails, but kind of both</a>. And now you're 1% closer to understanding how a quantum computer works.
...
Beyond just being useful for learning complex concepts, and framing old ideas in new ways, metaphor is the basis of nearly every thought we have. It's a fundamental building block of human cognition that shapes the way we percieve and interact with the world. <Tooltip tiptext={<span>This goes a bit too deep to elaborate on here, but <a to="https://en.wikipedia.org/wiki/Conceptual_metaphor">Cognitive Metaphor Theory</a> is beautifully mind-blowing and worth exploring when you have time. A good starting point is the book <a to="https://en.wikipedia.org/wiki/Metaphors_We_Live_By">Metaphors We Live By</a> written by <a to="https://en.wikipedia.org/wiki/George_Lakoff">George Lakoff</a> and <a to="https://en.wikipedia.org/wiki/Mark_Johnson_(philosopher)">Mark Johnson</a>.</span>}>5</Tooltip>
...
Try, for a moment to imagine what "<a to="https://egghead.io/courses/use-typescript-to-develop-react-applications">Typescript with React</a>" visually looks like.  Or "<a to="https://egghead.io/courses/build-a-server-rendered-reactjs-application-with-next-js">A Server-rendered ReactJS Application with Next.js</a>".  Or the "<a to="https://egghead.io/courses/state-monad-in-javascript">State Monad in JavaScript</a>"
...
Two illustrators I consider the cream of the metaphorical crop are <a to="https://www.emilianoponzi.com/">Emiliano Ponzi</a> and <a to="https://chasematt.com/">Matt Chase</a>.  Take a look at a few of their creations:
