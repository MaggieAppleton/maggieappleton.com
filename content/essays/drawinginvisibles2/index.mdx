...
Our goal here is to research what  **cultural symbols** are associated with the idea of _web security_, and then play with those symbols to come up with a meaningful illustration. 

Signs and symbols are anything that represents something other than the thing itself. Red traffic lights mean hit the brakes, fire alarm noises mean get out of the building, and xxx means xxx. <Footnote idName={1}>In anthropology, we call the study of signs and symbols [semiotics](https://en.wikipedia.org/wiki/Semiotics).</Footnote> 
...
These assumptions I'm making as a creator are flawed, and always have been. You, dear reader, are part of an imagined blob of people I have to make educated guesses about, primarily based on my own experience of the world and people I spend time with.

This is just as true with illustration as it is with writing.
