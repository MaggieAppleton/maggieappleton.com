...
I always start by making a long, freewheeling list of words and icons that I associate with the main concept.

To do this, I grab a blank piece of paper or a fresh canvas in [Procreate](https://procreate.art/) if I'm working on the iPad. <Footnote idName={4}>The technical details don't matter at this stage, but for the curious I use a large 4000 x 5000px canvas to make sure I have lots of space to work in. Nothing worse than running out of imaginary digital paper.</Footnote> I also sometimes do this as a typed list if I'm on my phone.

The main goal here is you want to get down all the 
