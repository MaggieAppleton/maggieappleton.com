...
Given that we've approaching this illustration as anthropologists, our main goal here is to research the  **cultural symbols, signs, and associations** around the thing we're trying to visually communicate. This means paying attention to the way people talk about it on community forums, Twitter, in "the mainstrea media," published books, blogs, or depict it in films, GIFs, and cheesy stock images.

The idea of _web security_ comes pre-baked with a wealth of cultural associations. When you read the words '_web security_', your brain fires off a whole host of neurons based on times it's seen that phrase in the past. Every time you watch a talk, have a conversation, or read an article that involves the idea of _web security_, you create new synaptic connections that expand your understanding of the concept. These link up with the neurons that hold your notions of _passwords_, _hackers_, and _firewalls_. These connections are hardwired into your brain. You cannot think about _web security_ without triggering those associated maps of meaning.
