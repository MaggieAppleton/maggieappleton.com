...
If you and I run in the same cultural circles (english-speaking, technically literate, generically Westernised, web development nerds), we'll have encountered many of the same celebrities, historical events, films, articles, and public conversations related to _web security_. Our mental maps are probably alike. They won't be exactly the same, but I assume you have heard of 4chan, Mark Zuckerberg, DDOS attacks, and the film [_Her_](https://en.wikipedia.org/wiki/Her_(film)). <Footnote idName={4}>These assumptions I'm making as a creator are flawed, and always have been. You, dear reader, are part of an imagined blob of people I have to make educated guesses about, primarily based on my own experience of the world and people I spend time with. This is just as true with illustration as it is with writing.</Footnote>
