...
Scientists constantly try to remove themselves from **being** in the world, using protocols that allow them to **know** in ways that are purposefully removed from a specific context. A phenomenon clearly laid out in much of <a to="/modern">Bruno Latour</a>'s work.
