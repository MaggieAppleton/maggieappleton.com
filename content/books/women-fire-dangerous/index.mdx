...
Lakoff titled this book for on the Australian aboriginal language of <a to="https://en.wikipedia.org/wiki/Dyirbal_people">Dyirbal</a>.  Dyirbal has a category called *balan* that indeed includes women, fire, and dangerous things. However, it also includes many non-dangerous things like bandicoots, echnidnas, and the stars. <Footnote count={1}>From Plaster, Keith and Maria Polinsky. 2007 <a to="https://dash.harvard.edu/bitstream/handle/1/3209556/Women%20are%20not%20dangerous%20things%20-%20Pol,%20M.pdf?sequence=2">Women are not dangerous things: Gender and categorization</a> </Footnote>
